...
function App() {
  ...
  const [messages, setMessages] = useState([
    {
      text: "Hi I am PetBot. How can I help you?",
      isBot: true,
    }
  ]);
    ...
    <div className="App">
      <div className="sideBar">
        <div className="upperSide">
          <div className="upperSideTop"><img src={gptLogo} alt="Logo" className="logo"/> <span className="brand">PetBot</span></div>
      ...
      <div className="main">
        ...
        <div className="chatFooter">
          ...
          <p>ChatBot may produce inaccurate information about pets, places, or facts.</p>
        </div>
